                ...
                <form action="{{ route('activity-store') }}" method="POST" id="activity_add_form">
                    ...
                    <div class="mt-3">
                     ...
                     <div class="form-check mt-3">
                        <input type="checkbox" class="form-check-input" id="showRecurring">
                        <label class="form-check-label" for="showRecurring">Is Recurring ? </label>
                    </div>
                {{-- *********** --}}

                   <div class="column-gap-2 justify-content-between" id="recurring-container">
                        <div class="mt-3">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#showRecurring').change(function () {
            if(this.checked) {
                $('#recurring-container').toggleClass('recurring-show');
            }else{
                $('#recurring-container').removeClass('recurring-show');
            }
        });
        ...
        $(".edit_activity").on('click', function (e) {
            ...
            console.log(activityData.is_recurring);
            let shouldCheck = activityData.is_recurring;

            if (shouldCheck) {
                    $('#showRecurring').prop('checked', true);
                    $('#recurring-container').addClass('recurring-show');
                } else {
                    $('#showRecurring').prop('checked', false);
                    $('#recurring-container').removeClass('recurring-show');
                }
