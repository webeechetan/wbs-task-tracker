                    ...
                    <form action="{{ route('activity-store') }}" method="POST">
                        ...
                        <div class="mt-3">
                          ...
                          <div class="input-group">                                      
                                <select class="form-control schedule" name="cron_day[]" id="cron_day" multiple>
                                    @php
                                        $currentDate = now();
                        ...
                        <div class="mt-3 reminder_date_div first-div">
                            ...
                            @enderror
                            <div class="mt-3">
                                <button type="button" class="btn btn-primary add-more"><i class='bx bx-plus'></i></button>
                                <button type="button" class="btn btn-danger remove"><i class='bx bx-minus'></i></button>
                            </div>
                        </div>
